...
/**
 * redis工具类(用于session共享缓存)
 * @Description redis工具类(用于session共享缓存)
 * @ClassName   RedisFactorySession 
 * @Date        2018年4月19日 上午1:18:15 
 * @Author      yz.teng
 */
public class RedisFactorySession {
    private static final Logger log = LogManager.getLogger(RedisFactorySession.class);
    ...
    public static void set(String key, String value) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,set error:", e);
            e.printStackTrace();
        }
        finally {
            close(jedis);
    ...
    public static void setexObject(String key, int seconds, Object value) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,setexObject error:", e);
        }
        finally {
            close(jedis);
        }
    ...
    public static <T> T getObject(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,getObject error:", e);
        }
        finally {
            close(jedis);
        }
    ...
    public static String get(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,get error:", e);
        }
        finally {
            close(jedis);
        }
    ...
    public static void delObject(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,delObject error:", e);
            e.printStackTrace();
        }
        finally {
            close(jedis);
    ...
    public static void del(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,del error:", e);
            e.printStackTrace();
        }
        finally {
            close(jedis);
    ...
    public static void expireObject(String key, int timeOut) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,expireObject error:", e);
            e.printStackTrace();
        }
        finally {
            close(jedis);
    ...
    public static void expire(String key, int timeOut) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,expire error:", e);
            e.printStackTrace();
        }
        finally {
            close(jedis);
    ...
    public static Long decr(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,decr error:", e);
        }
        finally {
            close(jedis);
        }
    ...
    public static Long incr(String key) {
        ...
        try {
            ...
            log.error("RedisFactorySession redis异常,incr error:", e);
        }
        finally {
            close(jedis);
        }
