...
public class RedisFactory {
    private static final Logger log = LogManager.getLogger(RedisFactory.class);
    ...
    public static Properties getJedisProperties() {
        ...
        InputStream is = null;
        try {
            is = RedisFactory.class.getClassLoader().getResourceAsStream("application.properties");
            config.load(is);
        }
        catch (IOException e) {
