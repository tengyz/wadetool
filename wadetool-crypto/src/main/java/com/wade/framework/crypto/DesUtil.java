...
public class DesUtil {
    ...
    public static void main(String[] args) {
        try {//Uac2wsxZAQ!
            ...
            String password = "Uac2wsxZAQ!";
            DesUtil des2 = new DesUtil("00385039");// 自定义密钥  
            System.out.println("加密前的字符：" + password);
            System.out.println("加密后的字符：" + des2.encrypt(password));
            System.out.println("解密后的字符：" + des2.decrypt(des2.encrypt(password))); //("")
        }
        catch (Exception e) {
            e.printStackTrace();
        }
