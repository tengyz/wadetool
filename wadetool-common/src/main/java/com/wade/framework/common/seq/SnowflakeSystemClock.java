 ...
 * @author lry
 */
public class SnowflakeSystemClock {
    
    private final long period;
    
    private final AtomicLong now;
    
    private SnowflakeSystemClock(long period) {
        this.period = period;
        this.now = new AtomicLong(System.currentTimeMillis());
        scheduleClockUpdating();
    }
    
    private static SnowflakeSystemClock instance() {
    ...
    private static class InstanceHolder {
        public static final SnowflakeSystemClock INSTANCE = new SnowflakeSystemClock(1);
    }
